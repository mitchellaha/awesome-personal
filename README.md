...
## Desktop/Web/System Agnostic Applications
...
- [Ghostty](https://github.com/ghostty-org/ghostty) ⭐️ - Fast Terminal
- [Hyper JS](https://github.com/vercel/hyper) - Terminal with Web Technologies
- [Fig](https://fig.io/) ❤️ - Autocomplete for the Terminal (RIP)
...
- [moudey/Shell](https://github.com/moudey/Shell) - ❤️ A context menu that doesnt suck
- [PowerToys](https://github.com/microsoft/PowerToys) ❤️ - Windows Utilities (++Command Pallete)
- [WezTerm](https://github.com/wezterm/wezterm) ❤️ - An Actual Terminal
- [MobaXTerm](https://mobaxterm.mobatek.net/) - Multiple Remote Protocols in One Tabbed Interface
